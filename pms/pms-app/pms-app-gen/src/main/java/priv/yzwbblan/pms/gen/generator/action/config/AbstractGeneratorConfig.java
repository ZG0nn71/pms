...
import priv.yzwbblan.pms.base.util.FileUtil;
import priv.yzwbblan.pms.gen.generator.engine.SimpleTemplateEngine;
import priv.yzwbblan.pms.gen.generator.engine.base.PmsTemplateEngine;
import priv.yzwbblan.pms.gen.generator.engine.config.ContextConfig;
import priv.yzwbblan.pms.gen.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doAdiGeneration() {
        PmsTemplateEngine pmssTemplateEngine = new SimpleTemplateEngine();
        pmssTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        pmssTemplateEngine.setSqlConfig(sqlConfig);
        pmssTemplateEngine.setTableInfo(tableInfo);
        pmssTemplateEngine.start();
    }
}
