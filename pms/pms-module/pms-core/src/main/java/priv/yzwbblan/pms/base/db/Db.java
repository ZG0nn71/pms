package priv.yzwbblan.pms.base.db;
...
import priv.yzwbblan.pms.base.util.SpringContextHolder;
...
public class Db<T> {
    ...
    private Db(Class clazz) {
        this.clazz = clazz;
        this.baseMapper = (BaseMapper<?>) priv.yzwbblan.pms.base.util.SpringContextHolder.getBean(clazz);
    }
