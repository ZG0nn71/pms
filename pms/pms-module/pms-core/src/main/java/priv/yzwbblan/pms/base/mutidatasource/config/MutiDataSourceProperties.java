package priv.yzwbblan.pms.base.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "pms.muti-datasource")
public class MutiDataSourceProperties {

    //默认的数据源名称
    private String defaultDataSourceName = "dataSourcepms";
